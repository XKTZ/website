  ...
  <div ref="appContainer">
    <el-container :style="`height: ${screenHeight}px;`">
      ...
      <el-container>
        ...
        <el-footer>
          <div class="links">
            <el-link href="https://github.com/XKTZ">
              <el-icon :size="30">
                <svg t="1636154976345" class="icon" viewBox="0 0 1024 1024" version="1.1"
...
import {ElAside, ElMain, ElIcon} from "element-plus";
...
export default {
  ...
  setup() {
    const screenHeight = screen.height * .85;
    return {screenHeight}
  }
}
